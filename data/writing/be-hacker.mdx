...
- Learn to Google
  ...
  - learn how to find answers to all of your questions
  - explore by yourself, figure out solutions to problems
  - I won't explain some of the things below in depth, that's your job
- Get Unix
  - first thing you should do is get a copy of Linux (or macOS) - you can dual boot any distro with Windows.
...
- Open-source
  - learn about Git, and how to do version control
...
- Design
  - learn the basics of color theory, typography, spacing
  - admire and take inspiration from other UIs (don't look at dribble, use are.na)
  - recreate some existing UI consistently for 2-3 weeks and you'll get good at design
