...
You _should_ use the native `<button>` element. You can find all its attributes <ExternalLink  href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button#attributes">here</ExternalLink>.

### Size

All buttons should have two or three different sizes - do this with <ExternalLink  href="https://www.npmjs.com/package/scalable">scalable</ExternalLink> sizes.
...
- <ExternalLink href='https://vercel.com/design/button#variant-shadow'>Vercel</ExternalLink>
- <ExternalLink href='https://mui.com/components/buttons/#basic-button'>MUI</ExternalLink>
...
According to <ExternalLink href="https://www.w3.org/TR/WCAG21/#target-size">w3.org</ExternalLink>: buttons should have at least 44 by 44px so make sure you achieve that to assure accessibility on mobile.

Read more here:

- <ExternalLink href='https://www.w3.org/TR/wai-aria-practices/#button'>Button</ExternalLink>
- <ExternalLink href='https://www.w3.org/TR/wai-aria-practices/#keyboard-interaction-3'>Keyboard</ExternalLink>
- <ExternalLink href='https://www.w3.org/TR/wai-aria-practices/#wai-aria-roles-states-and-properties-3'>WAI-Aria</ExternalLink>
