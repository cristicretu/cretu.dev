...
- <ExternalLink
    customLine={false}
    href="https://vercel.com/design/button#variant-shadow"
  >
    Vercel
  </ExternalLink>
- <ExternalLink
    customLine={false}
    href="https://mui.com/components/buttons/#basic-button"
  >
    MUI
  </ExternalLink>
...
customLine={false}
href="https://www.w3.org/TR/WCAG21/#target-size">w3.org</ExternalLink>: buttons should have at least 44 by 44px so make sure you achieve that to assure accessibility on mobile.
...
- <ExternalLink
    customLine={false}
    href="https://www.w3.org/TR/wai-aria-practices/#keyboard-interaction-3"
  >
    Keyboard
  </ExternalLink>
- <ExternalLink
    customLine={false}
    href="https://www.w3.org/TR/wai-aria-practices/#wai-aria-roles-states-and-properties-3"
  >
    WAI-Aria
  </ExternalLink>{' '}
