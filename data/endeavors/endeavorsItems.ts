export const endeavorsList = [
  {
    img: '/static/images/endeavors/deta.png',
    title: 'Deta',
    description:
      'This is where I currently work on creating a unique and engaging experience for the Deta brand.',
    link: 'https://deta.sh',
  ...
  // {
  //   img: '/static/images/endeavors/wordle.png',
  //   title: 'Romanian Wordle',
  //   description: 'Weekend project where I built a romanian wordle version.',
  //   link: 'https://github.com/cristicretu/wordle',
