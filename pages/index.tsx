      ...
      <div className='w-full'>
        ...
        <div className='grid grid-cols-3 grid-rows-1 gap-y-28 gap-x-2'>
          ...
          <div className='col-span-2 flex flex-col gap-4'>
            <Link href='/writing'>
              <a className='text-2xl font-serif text-gray-700 transition duration-200 ease-in-out cursor-pointer hover:text-gray-900 group dark:text-gray-400 dark:hover:text-gray-200'>
                Writing{' '}
                <span
                  aria-hidden='true'
                  className='inline-block transition-transform duration-200 ease-in-out translate-x-0 group-hover:translate-x-1'
