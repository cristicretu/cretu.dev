...
export default function Container(props) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <nav className="flex items-center sticky-nav justify-between w-full max-w-5xl py-6 px-10 mx-auto bg-white dark:bg-gray-900 bg-opacity-50 text-gray-900 dark:text-gray-100">
